...
local function is_confused(pathname, results, options)
  ...
  local count_tokens, count_well_understood_tokens = evaluation.count_tokens, evaluation.count_well_understood_tokens
  local num_tokens, num_well_understood_tokens = count_tokens(results), count_well_understood_tokens(results)
